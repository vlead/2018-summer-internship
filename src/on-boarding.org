...
* Things to Do before [2018-05-14 Mon]
  
  < To be confirmed by Thirumal>
...
** Leave Policy
   You are allowed to take only one leave in a month with prior notice to your
   mentor during the internship period.

** Work Logs
   1. Follow the =instructions.org= to create a work-logs directory.

   2. Work logs to be committed at the end of every day.  Create a file
      =first-name.org= in the =work-logs= directory and fill in the details.
      Please use =sample.org= as a template.

   3. You have to get your work-log approved from your mentor on a weekly
...
** Presentations
  1. All Friday afternoons will be reserved for a short presentation (5-10
  ...
  2. You will need to make a mid-internship presentation at the end of the 4th
     week of internship - week of 11th June to 15th July 2018.
